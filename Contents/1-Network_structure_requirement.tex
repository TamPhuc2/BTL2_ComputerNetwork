...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textit{Staff Wi-Fi (VLAN 40):} Mạng nội bộ cho y bác sĩ, yêu cầu mã hóa WPA3 và xác thực người dùng tập trung.
        \item \textit{Guest Wi-Fi (VLAN 110):} Mạng phục vụ bệnh nhân và khách vãng lai, được cô lập hoàn toàn với dữ liệu nội bộ và chỉ cho phép truy cập Internet.
    \end{itemize}
\end{itemize}
...
\hline
\textbf{VLAN} & \textbf{Tên phân vùng} & \textbf{Mục đích và Đối tượng sử dụng} \\ \hline
\endfirsthead
...
\hline
\caption{Danh mục các VLAN triển khai trong hệ thống}
\label{tab:vlan_definition}
\endlastfoot

10 & \textbf{DMZ} & Khu vực phi quân sự (Demilitarized Zone), chứa các Server công cộng như Web server, Mail-server và Gateway truy cập từ xa. \\ \hline
20 & \textbf{SERVER FARM} & Vùng máy chủ nội bộ tập trung, lưu trữ cơ sở dữ liệu (DB), hệ thống thông tin bệnh viện (HIS) và lưu trữ dữ liệu CCTV (IoT-Camera). \\ \hline
30 & \textbf{MANAGEMENT} & Dành riêng cho việc quản trị thiết bị hạ tầng (Switch, Router, Firewall, AP). Chỉ có kỹ thuật viên hệ thống mới có quyền truy cập. \\ \hline
40 & \textbf{MEDICAL} & Dành cho đội ngũ bác sĩ, y tá và kết nối các thiết bị y tế chuyên dụng, máy móc xét nghiệm, chẩn đoán hình ảnh. \\ \hline
50 & \textbf{ADMIN} & Phục vụ các tác vụ nghiệp vụ của khối hành chính, văn thư và các phòng ban chức năng tại trụ sở và chi nhánh. \\ \hline
60 & \textbf{FINANCE} & Phân vùng bảo mật cao dành cho bộ phận Kế toán, Thu ngân và quản lý hóa đơn, tài chính bệnh viện. \\ \hline
70 & \textbf{IT-OPS} & Dành cho đội ngũ vận hành CNTT, cho phép truy cập các công cụ giám sát mạng và hỗ trợ kỹ thuật (Helpdesk). \\ \hline
80 & \textbf{HR} & Quản lý dữ liệu nhân sự, bảng lương và hồ sơ cán bộ nhân viên. \\ \hline
90 & \textbf{CAMERA} & Cô lập lưu lượng dữ liệu video từ hệ thống CCTV và các cảm biến an ninh nhằm tránh gây nghẽn băng thông cho các vùng khác. \\ \hline
100 & \textbf{VOIP} & Ưu tiên lưu lượng (QoS) cho hệ thống điện thoại IP và truyền thông hợp nhất trong toàn cơ quan. \\ \hline
110 & \textbf{GUEST WIFI} & Cung cấp kết nối Internet cho bệnh nhân và khách vãng lai. Vùng này hoàn toàn bị cô lập khỏi các tài nguyên nội bộ. \\ \hline
\end{longtable}
